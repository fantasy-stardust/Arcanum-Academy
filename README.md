...
flowchart TB
    ...
    Below --> Forge["Lower Forgeworks<br/>The Artificers' Guild<br/>下层工坊"]
    West --> Scriptoria["Scriptoria<br/>誊写室"]
    West --> Recital["Recitation Halls<br/>诵读厅"]
    East --> Formula["Formula Halls<br/>公式廊"]
    East --> Labs["Crystal Laboratories<br/>晶体实验室"]
    South --> Gardens["Medicinal Gardens<br/>药圃"]
    South --> Living["Living Library<br/>活体图书馆"]
    North --> Maps["Cartographic Vault<br/>制图密库"]
    North --> Chronicle["Chronicle Stacks<br/>编年书库"]
    Forge --> Benches["Coding Benches<br/>编程台"]
    Forge --> Engines["Engine Rooms<br/>锻机房"]
    West -. Path of Voice .-> North
    North -. Path of Record .-> East
    East -. Path of Proof .-> South
    South -. Path of Renewal .-> Forge
    Forge -. Path of Making .-> West
```
...
```mermaid
flowchart LR
    Entry["Moon Gate Entry<br/>入院之门"] --> Oath["Lantern Oath<br/>灯庭宣誓"]
    Oath --> Rotation["First Circuit<br/>五院轮修"]
    Rotation --> Choice["Chosen Discipline<br/>定选学科"]
    Choice --> Practice["Notes / Exercises / Projects<br/>笔记 / 练习 / 项目"]
    Practice --> Trial["Hall Trial<br/>分殿试炼"]
    Trial --> Adept["Adept Scholar<br/>进阶学徒"]
    Adept --> Capstone["Grand Work<br/>总课题"]
    Capstone --> Scribe["Scribe / Orator<br/>书写者 / 演说者"]
    Capstone --> Measure["Scholar of Measure<br/>度量学者"]
    Capstone --> Lifekeeper["Lifekeeper<br/>生命守望者"]
    Capstone --> Archive["Archivist / Cartographer<br/>档案守录者 / 制图者"]
    Capstone --> Maker["Artificer<br/>造机者"]
```
